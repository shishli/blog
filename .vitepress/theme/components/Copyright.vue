<template>
    <div class="site-footer">
        MIT Licensed | Copyright © 2016-2025 <a class="vitepress" :href="website">{{ webTitle }}</a>
        <!-- <br /> -->
        <!-- Powered by <a class="vitepress" target="_blank" href="//vitepress.vuejs.org/">VitePress - 1.5.0</a> -->
